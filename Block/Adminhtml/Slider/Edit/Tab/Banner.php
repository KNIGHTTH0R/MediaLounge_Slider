...
class Banner extends \Magento\Backend\Block\Widget\Grid\Extended implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    {
        /** @var \MediaLounge\Slider\Model\ResourceModel\Banner\Collection $collection */
    ...
    /**
     * @param \MediaLounge\Slider\Model\Banner|\Magento\Framework\Object $item
     * @return string
     */
    ...
    {
        return $this->coreRegistry->registry('medialounge_slider_slider');
    }
    ...
    {
        return $this->getUrl('medialounge_slider/slider/banners', ['_current' => true]);
    }
