...
class Banner extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    )
    {
        ...
        $this->bannerSliderTable = $this->getTable('medialounge_slider_banner_slider');
    }
    ...
    {
        $this->_init('medialounge_slider_banner', 'banner_id');
    }
     ...
     *
     * @param \Magento\Framework\Model\AbstractModel|\MediaLounge\Slider\Model\Banner $object
     * @return $this
     */
     ...
     * @return array
     */
    public function getSlidersPosition(\MediaLounge\Slider\Model\Banner $banner)
    {
     ...
     * @return $this
     */
    protected function saveSliderRelation(\MediaLounge\Slider\Model\Banner $banner)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'medialounge_slider_banner_change_sliders',
